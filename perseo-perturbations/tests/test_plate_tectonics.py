...
"""Tests for geodynamics/plate_tectonics.py core functionalities"""

import numpy as np
import pytest

from perseo_perturbations.geodynamics.plate_tectonics import compute_displacement
...
class PlateTectonics:
    ...
    time = 2.5 * 3.154e7  # 2 and a half year in sec
