...
"""Unittest for perturbations/geodynamics/solid_tides.py core functionalities"""
...
class IERSSolidTidesTesting(unittest.TestCase):
...
class SolidTidesDisplacement(unittest.TestCase):
