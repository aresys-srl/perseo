...
"""Testing for geometry/pointing/attitude.py Attitude object"""
...
class TestAttitude:
    ...
    def setup_attitude_data(self, attitude_test_data: dict, reference_frames_test_data: dict) -> None:
        self.times = attitude_test_data["times"]
        self._euler_angles = attitude_test_data["euler_angles"]
        self.antenna_reference_frames = attitude_test_data["antenna_reference_frames"]
    ...
    def test_evaluate_at_knots(self) -> None:
    ...
    def test_evaluate_midpoints(self) -> None:
    ...
    def test_from_euler_angles(self) -> None:
    ...
    def test_compute_antenna_attitude_from_euler_angles(self) -> None:
    ...
    def test_compute_sensor_attitude_from_state_vectors(self) -> None:
