...
class InverseGeocodingMonostaticCoreTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # expected results
        self.azimuth_res = PreciseDateTime.from_utc_string("17-FEB-2020 16:07:09.730312980601")
...
class InverseGeocodingMonostaticInitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # expected results
        self.result = PreciseDateTime.from_utc_string("17-FEB-2020 16:07:04.908999712209")
