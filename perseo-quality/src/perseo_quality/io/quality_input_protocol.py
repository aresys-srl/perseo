...
@runtime_checkable
class ExtendedChannelData(ChannelData, Protocol):
    """Extension of original base ChannelData protocol used for Product Channel representation in PERSEO Quality.
