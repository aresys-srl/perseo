...
"""Unittest for target_ambiguity_ratio_analysis core functionalities"""
...
class TestTargetAmbiguityRatioFunctions(unittest.TestCase):
    ...
    def test_are_ambiguities_inside_scene_true(self) -> None:
        ...
        self.assertTrue(
            support.are_ambiguities_inside_scene(r_amb=(1219, 11860), l_amb=(508, 11860), lines=5180, samples=23000)
        )

    def test_are_ambiguities_inside_scene_false(self) -> None:
        """Testing are_ambiguities_inside_scene check function, false case"""
        self.assertFalse(
            support.are_ambiguities_inside_scene(r_amb=(12190, 11860), l_amb=(508, 11860), lines=5180, samples=23000)
        )
